...
<body>
	<div>
		...
		<form action="${pageContext.request.contextPath}/KhachHang/save"
			method="post">
			<label for="npn_hoten">Họ Tên:</label> <input type="text"
				name="npn_hoten" value="${command.npn_hoten}" required /><br /> <label
