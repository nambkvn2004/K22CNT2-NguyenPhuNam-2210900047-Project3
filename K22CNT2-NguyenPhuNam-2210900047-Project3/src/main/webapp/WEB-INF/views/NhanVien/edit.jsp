    ...
    <div>
        ...
        <form action="${pageContext.request.contextPath}/NhanVien/editsave" method="post">
            ...
            <select name="npn_chucvu" required>
                <option value="Nhan Vien Phuc Vu" ${command.npn_chucvu == 'PhucVu' ? 'selected' : ''}>Nhân viên Phục Vụ</option>
                <option value="Nhan Vien Bep" ${command.npn_chucvu == 'Bep' ? 'selected' : ''}>Nhân viên Bếp</option>
